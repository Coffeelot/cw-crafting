...
function cwCallback.await(name, ...)
    ...
    TriggerServerEvent('cw-crafting:server:triggerServerCallback', name, id, ...)

    return Citizen.Await(p)[1]
end

RegisterNetEvent('cw-crafting:client:serverCallback')
AddEventHandler('cw-crafting:client:serverCallback', function(id, ...)
